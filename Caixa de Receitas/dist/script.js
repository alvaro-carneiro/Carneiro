class Layout extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      React.createElement(BoxesContainer, null));
...
class Footer extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      React.createElement("footer", { className: "page__footer" }, /*#__PURE__*/
      React.createElement("div", { className: "container" }, /*#__PURE__*/
      React.createElement("div", { className: "column four" }, /*#__PURE__*/
      React.createElement("h2", null, "Connect"), /*#__PURE__*/
      React.createElement("ul", { className: "connect-list" }, /*#__PURE__*/
      React.createElement("li", { className: "connect-list__item" }, /*#__PURE__*/
      React.createElement("a", {
        className: "connect-list__link",
        href: "https://uk.linkedin.com/in/edd-yerburgh-74aa5768",
        target: "newwindow" }, /*#__PURE__*/

      React.createElement("i", { className: "zmdi zmdi-linkedin zmdi-hc-5x" }))), /*#__PURE__*/
      ...
      React.createElement("i", { className: "zmdi zmdi-github-alt zmdi-hc-5x" }))), /*#__PURE__*/
      ...
      React.createElement("i", { className: "zmdi zmdi-codepen zmdi-hc-5x" }))))))));
...
class BoxesContainer extends React.Component {
  ...
  render() {
    ...
    if (this.state.showBox) {
      box = /*#__PURE__*/React.createElement(Box, {
    ...
    return /*#__PURE__*/(
      ...
      React.createElement(HeaderHeader, {
        add: this.addRecipe.bind(this) }), /*#__PURE__*/

      React.createElement(Index, {
        data: this.state.data,
        show: this.showBox.bind(this) }), /*#__PURE__*/
  ...
  render() {
    return /*#__PURE__*/(
      React.createElement("div", {
        className: "tile",
        onClick: this.handleClick.bind(this) }, /*#__PURE__*/

      React.createElement(TileMain, {
        title: this.props.data.title,
        img: this.props.data.img }), /*#__PURE__*/
...
class TileMain extends React.Component {
  ...
  render() {
    ...
    var heroDiv;
    if (this.props.img) {
      heroDiv = /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/(
      ...
      heroDiv, /*#__PURE__*/
      React.createElement("header", { className: "tile__header" }, /*#__PURE__*/
      React.createElement("h2", { className: "tile__title" }, " ", this.props.title, " "))));
...
class Index extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/(
      React.createElement("div", { className: "container" }, /*#__PURE__*/
      React.createElement("main", { className: "tile-container" },
      tileNodes)));
...
class TileFooter extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      React.createElement("footer", { className: "tile__footer" }, /*#__PURE__*/
      React.createElement("button", { className: "btn-primary" }, /*#__PURE__*/
      React.createElement("i", { className: "zmdi zmdi-open-in-new zmdi-hc-lg btn-icon" }), " open recipe")));
...
class HeaderHeader extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      React.createElement("header", { className: "page__header" }, /*#__PURE__*/
      React.createElement("div", { className: "container flex-container" }, /*#__PURE__*/
      ...
      !this.state.isHidden && /*#__PURE__*/React.createElement(AddRecipe, { add: this.props.add, toggleHidden: this.toggleHidden.bind(this) })));
...
class AddRecipe extends React.Component {
  ...
  render() {
    var error;
    if (this.state.error) {
      error = /*#__PURE__*/React.createElement("span", { className: "text-color-warning" }, "You must complete all fields marked as required");
    ...
    return /*#__PURE__*/(
      ...
      React.createElement("div", { className: "form-bg" }, /*#__PURE__*/
      React.createElement("form", {
        className: "form",
        onSubmit: this.handleSubmit.bind(this) }, /*#__PURE__*/

      React.createElement("i", {
        className: "zmdi zmdi-close zmdi-hc-2x pull-right",
        onClick: this.props.toggleHidden }), /*#__PURE__*/

      React.createElement("h2", { className: "form__title" }, "Add Recipe"), /*#__PURE__*/
      React.createElement("label", { for: "recipeName" }, "Recipe name *"), /*#__PURE__*/
      React.createElement("input", {
        id: "recipeName",
        type: "text",
        onChange: this.handleTitleChange.bind(this) }), /*#__PURE__*/

      React.createElement("label", { for: "recipeName" }, "Ingredients *"), /*#__PURE__*/
      React.createElement("textarea", {
        id: "ingredients",
        onChange: this.handleIngredientsChange.bind(this) }), /*#__PURE__*/

      React.createElement("label", { for: "ingredients" }, "Instructions *"), /*#__PURE__*/
      React.createElement("textarea", {
        onChange: this.handleInstructionsChange.bind(this) }), /*#__PURE__*/

      React.createElement("label", { for: "imageUrl" }, "Image URL (optional)"), /*#__PURE__*/
      React.createElement("input", {
        id: "imageUrl",
        type: "text",
        onChange: this.handleImageChange.bind(this) }), /*#__PURE__*/
  ...
  render() {
    return /*#__PURE__*/(
      React.createElement("button", {
        ...
        onClick: this.props.toggleHidden }, "Add recipe"));
...
class Main extends React.Component {
  ...
  render() {
    ...
    const editImg = /*#__PURE__*/React.createElement("input", {
      type: "text",
    ...
    return /*#__PURE__*/(
      React.createElement("main", {
        className: "box__main" }, /*#__PURE__*/

      React.createElement("div", { className: "row" }, /*#__PURE__*/
      React.createElement("div", { className: "column six" }, /*#__PURE__*/
      React.createElement("h3", { className: "box__subheading" }, "Ingredients"), /*#__PURE__*/
      React.createElement("p", {
        className: "box__ingredients",
        contentEditable: editable ? true : false,
        onBlur: this.handleChangeIngredients.bind(this),
        dangerouslySetInnerHTML: this.rawMarkup(this.props.ingredients) })), /*#__PURE__*/
...
class Header extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      React.createElement("header", {
        className: "box__header" }, /*#__PURE__*/
...
class BoxFooter extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      React.createElement("footer", { className: "box__footer" }, /*#__PURE__*/
      React.createElement("button", {
        className: "btn-warning",
        onClick: this.props.delete }, /*#__PURE__*/

      React.createElement("i", { className: "zmdi zmdi-delete zmdi-hc-lg btn-icon" }), " Delete"), /*#__PURE__*/

      React.createElement("button", {
        onClick: this.props.toggleEdit }, /*#__PURE__*/

      React.createElement("i", { className: "zmdi zmdi-edit zmdi-hc-lg btn-icon" }), " Edit")));
  ...
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement(Header, {
        ...
        update: this.updateRecipe.bind(this),
        close: this.props.close }), /*#__PURE__*/
      ...
      React.createElement(Main, {
        ...
        img: this.props.data.img,
        editable: this.state.editable,
        update: this.updateRecipe.bind(this) }), /*#__PURE__*/
...
ReactDOM.render( /*#__PURE__*/React.createElement(MyApp, null), app);